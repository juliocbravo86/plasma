...
<div id="wrap" class="clearfix">
  ...
  <div id="copyright">
    <?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <a href="<?php print $front_page; ?>"><?php print $site_name; ?></a>. <?php print t('Theme by'); ?>  <a href="http://www.devsaran.com" target="_blank">Bravo&Castellon</a><br/>
	<a href="http://localhost/plasma_sanguineo/?q=user">loguearse</a>
  </div>
</div>